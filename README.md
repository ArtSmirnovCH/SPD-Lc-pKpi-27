...
9. Implement data fit.
[fits (ipynb)](https://github.com/ArtSmirnovCH/SPD-Lc-pKpi-27/blob/master/analysis_notebooks/fits.ipynb)

10. MVA... (Investigate/Implement a Multivariate Analysis approach)
